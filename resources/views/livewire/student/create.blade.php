    ...
    <form wire:submit="save">
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                ...
                <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 ">Select Class</label>
            ...
            <div>
                ...
                <select id="countries" wire:model="section_id"
                    ...
                    @foreach($sections as $section)
                        <option value="{{$section->id}}"> {{$section->name}} - {{$section->classes->name}}</option>
                    @endforeach
                </select>
